...
export default function Form() {
    ...
    return (
        <form onSubmit={handleSubmit} className="bg-white/10 shadow-white/50 shadow-lg backdrop-blur-xs border border-white/40 rounded-xl p-5 mt-10 m-2 flex flex-col justify-center items-stretch min-h-40 space-y-3">
            <div>
